...
from aiosmb.dcerpc.v5.dtypes import NULL, DWORD, LPWSTR, LPBYTE, LMSTR, ULONG, GUID, LPLONG, WSTR, \
...
# HELPER FUNCTIONS
################################################################################
async def hNetrConnectionEnum(dce, qualifier, level, resumeHandle = 0, preferedMaximumLength = 0xffffffff):
...
async def hNetrFileEnum(dce, basePath, userName, level, resumeHandle = 0, preferedMaximumLength = 0xffffffff):
...
async def hNetrFileGetInfo(dce, fileId, level):
...
async def hNetrFileClose(dce, fileId):
    request = NetrFileClose()
    request['ServerName'] = NULL
    request['FileId'] = fileId
    return await dce.request(request)

async def hNetrSessionEnum(dce, clientName, userName, level, resumeHandle = 0, preferedMaximumLength = 0xffffffff):
...
async def hNetrSessionDel(dce, clientName, userName):
...
async def hNetrShareAdd(dce, level, infoStruct):
...
async def hNetrShareDel(dce, netName):
    request = NetrShareDel()
    request['ServerName'] = NULL
    request['NetName'] = netName
    return await dce.request(request)

async def hNetrShareEnum(dce, level, resumeHandle = 0, preferedMaximumLength = 0xffffffff):
...
async def hNetrShareEnumSticky(dce, level, resumeHandle = 0, preferedMaximumLength = 0xffffffff):
...
async def hNetrShareGetInfo(dce, netName, level):
...
async def hNetrShareSetInfo(dce, netName, level, shareInfo):
...
async def hNetrShareDelSticky(dce, netName):
...
async def hNetrShareDelStart(dce, netName):
    request = NetrShareDelStart()
    request['ServerName'] = NULL
    request['NetName'] = netName
    return await dce.request(request)

async def hNetrShareDelCommit(dce, contextHandle):
    request = NetrShareDelCommit()
    request['ContextHandle'] = contextHandle
    return await dce.request(request)

async def hNetrShareCheck(dce, device):
    request = NetrShareCheck()
    request['ServerName'] = NULL
    request['Device'] = device
    return await dce.request(request)

async def hNetrServerGetInfo(dce, level):
    request = NetrServerGetInfo()
    request['ServerName'] = NULL
    request['Level'] = level
    return await dce.request(request)

async def hNetrServerDiskEnum(dce, level, resumeHandle = 0, preferedMaximumLength = 0xffffffff):
...
async def hNetrServerStatisticsGet(dce, service, level, options):
...
async def hNetrRemoteTOD(dce):
    request = NetrRemoteTOD()
    request['ServerName'] = NULL
    return await dce.request(request)

async def hNetrServerTransportEnum(dce, level, resumeHandle = 0, preferedMaximumLength = 0xffffffff):
...
async def hNetrpGetFileSecurity(dce, shareName, lpFileName, requestedInformation):
...
async def hNetprPathType(dce, pathName, flags):
...
async def hNetprPathCanonicalize(dce, pathName, prefix, outbufLen=50, pathType=0, flags=0):
...
async def hNetprPathCompare(dce, pathName1, pathName2, pathType=0, flags=0):
...
async def hNetprNameValidate(dce, name, nameType, flags=0):
...
async def hNetprNameCanonicalize(dce, name, outbufLen=50, nameType=0, flags=0):
...
async def hNetprNameCompare(dce, name1, name2, nameType=0, flags=0):
...
async def hNetrDfsGetVersion(dce):
    request = NetrDfsGetVersion()
    request['ServerName'] = NULL
    return await dce.request(request)

async def hNetrServerAliasAdd(dce, level, aliasInfo):
...
async def hNetrServerAliasDel(dce, level, aliasInfo):
...
async def hNetrServerAliasEnum(dce, level, resumeHandle = 0, preferedMaximumLength = 0xffffffff):

...
from aiosmb.dcerpc.v5.ndr import NDRCALL, NDRENUM, NDRUNION, NDRUniConformantVaryingArray, NDRPOINTER, NDR, NDRSTRUCT, \
...
# HELPER FUNCTIONS
################################################################################
async def hLsarOpenPolicy2(dce, desiredAccess = MAXIMUM_ALLOWED):
...
async def hLsarOpenPolicy(dce, desiredAccess = MAXIMUM_ALLOWED):
...
async def hLsarQueryInformationPolicy2(dce, policyHandle, informationClass):
    request = LsarQueryInformationPolicy2()
    request['PolicyHandle'] = policyHandle
    request['InformationClass'] = informationClass
    return await dce.request(request)

async def hLsarQueryInformationPolicy(dce, policyHandle, informationClass):
    request = LsarQueryInformationPolicy()
    request['PolicyHandle'] = policyHandle
    request['InformationClass'] = informationClass
    return await dce.request(request)

async def hLsarQueryDomainInformationPolicy(dce, policyHandle, informationClass):
    request = LsarQueryInformationPolicy()
    request['PolicyHandle'] = policyHandle
    request['InformationClass'] = informationClass
    return await dce.request(request)

async def hLsarEnumerateAccounts(dce, policyHandle, preferedMaximumLength=0xffffffff):
    request = LsarEnumerateAccounts()
    request['PolicyHandle'] = policyHandle
    request['PreferedMaximumLength'] = preferedMaximumLength
    return await dce.request(request)

async def hLsarEnumerateAccountsWithUserRight(dce, policyHandle, UserRight):
    request = LsarEnumerateAccountsWithUserRight()
    request['PolicyHandle'] = policyHandle
    request['UserRight'] = UserRight
    return await dce.request(request)

async def hLsarEnumerateTrustedDomainsEx(dce, policyHandle, enumerationContext=0, preferedMaximumLength=0xffffffff):
...
async def hLsarEnumerateTrustedDomains(dce, policyHandle, enumerationContext=0, preferedMaximumLength=0xffffffff):
...
async def hLsarOpenAccount(dce, policyHandle, accountSid, desiredAccess=MAXIMUM_ALLOWED):
...
async def hLsarClose(dce, objectHandle):
    request = LsarClose()
    request['ObjectHandle'] = objectHandle
    return await dce.request(request)

async def hLsarCreateAccount(dce, policyHandle, accountSid, desiredAccess=MAXIMUM_ALLOWED):
...
async def hLsarDeleteObject(dce, objectHandle):
    request = LsarDeleteObject()
    request['ObjectHandle'] = objectHandle
    return await dce.request(request)

async def hLsarEnumeratePrivilegesAccount(dce, accountHandle):
    request = LsarEnumeratePrivilegesAccount()
    request['AccountHandle'] = accountHandle
    return await dce.request(request)

async def hLsarGetSystemAccessAccount(dce, accountHandle):
    request = LsarGetSystemAccessAccount()
    request['AccountHandle'] = accountHandle
    return await dce.request(request)

async def hLsarSetSystemAccessAccount(dce, accountHandle, systemAccess):
    request = LsarSetSystemAccessAccount()
    request['AccountHandle'] = accountHandle
    request['SystemAccess'] = systemAccess
    return await dce.request(request)

async def hLsarAddPrivilegesToAccount(dce, accountHandle, privileges):
...
async def hLsarRemovePrivilegesFromAccount(dce, accountHandle, privileges, allPrivileges = False):
...
async def hLsarEnumerateAccountRights(dce, policyHandle, accountSid):
    request = LsarEnumerateAccountRights()
    request['PolicyHandle'] = policyHandle
    request['AccountSid'].fromCanonical(accountSid)
    return await dce.request(request)

async def hLsarAddAccountRights(dce, policyHandle, accountSid, userRights):
...
async def hLsarRemoveAccountRights(dce, policyHandle, accountSid, userRights):
...
async def hLsarCreateSecret(dce, policyHandle, secretName, desiredAccess=MAXIMUM_ALLOWED):
...
async def hLsarOpenSecret(dce, policyHandle, secretName, desiredAccess=MAXIMUM_ALLOWED):
...
async def hLsarSetSecret(dce, secretHandle, encryptedCurrentValue, encryptedOldValue):
    request = LsarOpenSecret()
...
async def hLsarQuerySecret(dce, secretHandle):
...
async def hLsarRetrievePrivateData(dce, policyHandle, keyName):
    ...
    if err is not None:
        return None, err
    return b''.join(retVal['EncryptedData']['Buffer']), None

async def hLsarStorePrivateData(dce, policyHandle, keyName, encryptedData):
...
async def hLsarEnumeratePrivileges(dce, policyHandle, enumerationContext = 0, preferedMaximumLength = 0xffffffff):
...
async def hLsarLookupPrivilegeValue(dce, policyHandle, name):
    request = LsarLookupPrivilegeValue()
    request['PolicyHandle'] = policyHandle
    request['Name'] = name
    return await dce.request(request)

async def hLsarLookupPrivilegeName(dce, policyHandle, luid):
...
async def hLsarSetInformationPolicy2(dce, policyHandle, informationClass, policyInformation):
...
async def hLsarSetInformationPolicy(dce, policyHandle, informationClass, policyInformation):
